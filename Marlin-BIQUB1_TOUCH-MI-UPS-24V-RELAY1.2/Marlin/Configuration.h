...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb/3D Electroshop, BIQU B1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BIQU B1 TM 3D Electroshop"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.9, 79.9, 403.5, 103 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1.5, -35.5, -0 }
 ...
 */
//#define Z_PROBE_END_SCRIPT "G1 Z-1\nG1 Z10"
