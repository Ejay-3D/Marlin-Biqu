...
#define STRING_CONFIG_H_AUTHOR "(3DElectroshop, BIQU B1 BLTouch - Eeprom)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Electro BIQU B1"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.9, 79.9, 404, 104 }
