...
#define STRING_CONFIG_H_AUTHOR "(BIQU-EJAY3D, BIQU-B1-SKR2BL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BIQU-B1-SKR2BL"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 402, 99 }
