...
#define STRING_CONFIG_H_AUTHOR "(Luke Harrison MOD EJay3D, BIQU BX)" // Who made the changes.
...
#define Z_SAFE_HOMING_X_POINT   32// (X_CENTER / 8)  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT   36// (Y_CENTER / 8)  // Y point for Z homing
#endif
